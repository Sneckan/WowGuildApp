...
namespace WowGuildApp.Controllers
{
    public class CommentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Text,Date,PostId")] Comment comment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Text,Date,PostId")] Comment comment)
        {
            if (id != comment.Id)
            {
                return NotFound();
